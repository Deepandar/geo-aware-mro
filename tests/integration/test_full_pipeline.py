...
def test_required_columns_exist(
    ...
    missing = [
        ...
        c
        for c in V1_1_REQUIRED_COLUMNS
...
def test_procurement_flags_are_vital(
    pipeline_df
):
...
def test_sourcing_strategy_valid(
    pipeline_df
):
...
def test_buffer_stock_signal_non_negative(
    pipeline_df
):
...
def test_high_risk_drives_dual_source(
    pipeline_df
):
